...
bool modules_window::iscmdpropertiesavail(wstring_handle* const& out_file_path)
{
	bool avail;
...
void modules_window::setcmdproperties(cmd_properties_fn_t const& cmd_properties_fn, cmd_properties_ctx_t const& cmd_properties_ctx)
{
